                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= route_to('forgot') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" placeholder="Masukkan Email Anda">
